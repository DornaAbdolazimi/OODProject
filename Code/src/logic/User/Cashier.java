<<<<<<< HEAD:Code/src/logic/Cashier.java
package logic;
...
public class Cashier {
   /* public static String db_cashier =  "cashier";
    ...
    public void makeItem(String name, float price, int quantity, String group) {
            Item item = new Item(ItemDBManager.getNewItemID(), name, Math.round(price), quantity);
            item.setGroupId(DBManager.getGroupWithName(group).getId());
            ItemDBManager.insertNewItemIntoDB(item);
    ...
    public void makeSalesman( String official, String email) {
        ...
        CustomerSalesman salesman = new CustomerSalesman(CustomerSalesmanDBManager.getNewCustomerSalesmanID());
        ...
        CustomerSalesmanDBManager.insertNewCustomerSalesmanIntoDB(salesman);
    ...
    public void makeCustomer(String firstName, String lastName, String email) {
        CustomerSalesman customer = new CustomerSalesman(CustomerSalesmanDBManager.getNewCustomerSalesmanID());
        customer.setCustomer(true);
        customer.setFirstName(firstName);
        customer.setLastName(lastName);
        customer.setEmail(email);
        customer.setPhoneNumber(String.valueOf(Math.random())); //TODO
        CustomerSalesmanDBManager.insertNewCustomerSalesmanIntoDB(customer);
    ...
    public void createOrder (boolean isSell, int personID,
                             ArrayList<String> itemsAndQuantity){

        Order order = new Order(OrderDBManager.getNewOrderID());
        ...
        for (int i = 0; i < itemsAndQuantity.size(); i++) {
            String itemName = itemsAndQuantity.get(i).split(":")[0]; //TODO
            Item item = ItemDBManager.getItemWithName(itemName);
            int quantity = Integer.parseInt(itemsAndQuantity.get(i).split(":")[1]); //TODO change it
            ...
            ItemDBManager.updateItemQuantityInDB(item);
        }
        OrderDBManager.insertNewOrderIntoDB (order);
...
>>>>>>> 25ba95dad4c753f236ae7452cecce45a6e7d9cf9:Code/src/logic/User/Cashier.java
